...
if (isset($_POST["add-departure"])) {
    ...
    $insert = "INSERT INTO `flight` (flight_description, departure, airplane, seats_total, seats_left, arrival_airport, company, `type`, departure_airport, ticket_price) 
                VALUES ('$description', '$departure', '$airplane', '$seats', '$seats', '$airport_arrival', '$company', '$type', '$airport_dep','$ticket_price')";
...
<main class="admin-panel">
    ...
    <div class="admin-container">
        <form method="post" class="field-left">
            ...
            <input type="hidden" id="airport_dep" name="airport_dep" class="form-input" value="31">
            <input type="hidden" id="type" name="type" class="form-input" value="departure">
            <select name="airport_arrival" id="airport_arrival" class="form-input">
