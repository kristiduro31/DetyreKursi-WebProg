...
<main class="admin-panel">
    ...
    <div class="admin-container">
        <form method="post" class="field-left">
            <input type="datetime-local" id="departure" name="departure" class="form-input" placeholder="Arrival">
            ...
            <input type="hidden" id="arrival_airport" name="arrival_airport" class="form-input" value="31">
            <input type="hidden" id="type" name="type" class="form-input" value="Arrival">
            <select name="dept_airport" id="dept_airport" class="form-input" style="margin-left: 15px">
            ...
            <button type="submit" class="login-button" name="add-arrival" id="add-airport-button"
