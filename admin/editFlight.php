...
<main class="admin-panel">
    ...
    <div class="admin-container">
        <form method="post" class="field-left" action="../back-end/update.php">
            ...
            <input type="number" id="seats" name="seats" class="form-input" placeholder="Vende Total" value="<?php echo $row["seats_total"]; ?>">

                <input type="text" value="<?php echo $row["type"]?>" name="type" readonly="readonly" class="form-input">
            ...
            <select name="company" id="company" class="form-input" style='margin-left: 15px'>
                ...
                <input type="number" step="0.01" id="ticket_price" name="ticket_price" class="form-input" placeholder="Cmimi i biletes" value="<?php echo $row['ticket_price']?>">
