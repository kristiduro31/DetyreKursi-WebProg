    ...
    <div class = "container">
        <div class = "row" >
            <div class = "footer-col" >
                <h4>Fluturimet</h4>
                <ul>
                    <li><a href="../front-end/landing-page.php#fluturime-nisje">Nisjet</a></li>
                    <li><a href="../front-end/landing-page.php#fluturime-mberritje">Mbërritjet</a></li>
                    <li><a href="../front-end/landing-page.php#check-in">Checking-in</a></li>
                </ul>
            </div>
            <div class="footer-col">
                <h4>Shërbimet</h4>
            ...
            <div class="footer-col" style="padding-left: 5px">
                ...
                <ul>
                    <li><a id="pathToTIA" href="https://www.google.com/maps/dir//tia+address/@41.3703798,19.6917256,12z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x13502d0712c5607f:0x5254c1f62d5286db!2m2!1d19.714428!2d41.4191706">
                            <i class="fas fa-map-marker-alt"></i> Rr. Nënë Tereza, Rinas 1504, Albania</a></li>
                </ul>
            </div>
        </div>
    </div>
