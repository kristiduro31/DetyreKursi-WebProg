<nav>
    <ul>
        ...
        <li>
            ...
            <ul>
                <li><a href="../admin/admin-manage.php">Administratore <i class="fa-sharp fa-solid fa-user-tie" style="margin-left: 0"></i></a></li>
                <li><a href="../admin/user-manage.php">Perdoruesit <i class="fa-solid fa-user" style="margin-left: 0"></i></a></li>
            </ul>
        </li>
