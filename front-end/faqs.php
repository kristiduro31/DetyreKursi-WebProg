...
<head>
	<meta charset="UTF-8">
	<title>Pyetje te shpeshta</title>
    ...
    <div class="reg-container-main">
        ...
        <div class="main-paragraph">
            ...
            <p>Ju gjithashtu do të duhet të jepni detajet e kontaktit dhe një adresë dërgimi. Nëse po vizitoni destinacione të shumta, jepni të gjitha adresat pasi mund të duhen disa ditë që çanta juaj të gjendet.
                Nëse nuk jeni në gjendje të regjistroni të dhënat tuaja në aeroport, keni shtatë ditë për të regjistruar problemin në linjën tuaj ajrore.</p>
        </div>
        <div class="table-title" style="margin-top: 0px">
        ...
        <div class="main-paragraph" style="margin-bottom: 35px">
            ...
            <p>Kur mbërrini në Shqiperi, aktualisht nuk keni nevojë të bëni ndonjë test para nisjes ose pas mbërritjes për COVID-19. Kjo vlen pavarësisht nëse jeni i vaksinuar apo jo.
                Për informacionet më të fundit, ju lutemi vizitoni faqet udhëzuese të qeverisë për udhëtimin për COVID.</p>
        </div>
    </div>
</main>
