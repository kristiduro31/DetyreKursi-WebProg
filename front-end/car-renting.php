    ...
    <div class="reg-container-main">
        ...
        <div class="rental">
            <ul class="display-rentals">
                            ...
                            <div class="column">
                                ...
                                <div class="column-inside">
                                    ...
                                    <div class="detail">
                                        <label>Website</label>
                                        <h4><a target="_blank"
                                               href="http://www.albaniarentalcars.com">www.albaniarentalcars.com</a>
                                    </div>
                                </div>
                            </div>
                    </details>
                ...
                <li style="display: block;">
                    <details class="car-rental">
                        <summary><h3>Albania Car Rentals</h3></summary>
                        <div class="row">
                            <div class="column">
                                <div class="column-inside">
                                ...
                                <div class="column-inside">
                                    <h3 style="font-weight: bolder">Përshkrimi</h3>
                                    <p>Makina me qira me çmime të mira mund t'i gjeni vetëm tek
                                    Albanian Car Rents. Markat më të suksesshme, cilësi dhe  </p>
                                </div>
                                <div class="column-inside">
                                    <h3>Kontakt</h3>
                                    <div class="detail">
